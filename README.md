...
From that research, I put my bullet points into Cursor (Composer 2.5) with a full rundown of my findings to create a brief. I would not usually rely this heavily on AI for discovery, but to keep within the 3–4 hour limit I used it here — [Website_Breif.txt](./Task%20Assets/Website_Breif.txt).
